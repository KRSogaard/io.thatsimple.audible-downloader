...
public class ParseAudioBook {
    ...
    public List<ParseAudioBookPerson> Authors { get; set; }
    ...
    public List<ParseAudioBookSeries> Series { get; set; }

    [JsonPropertyName("categories")]
    public List<ParseAudioBookCategory> Categories { get; set; }
...
public class ParseSeries {
    ...
    public List<ParseSeriesBook> Books { get; set; }
}
